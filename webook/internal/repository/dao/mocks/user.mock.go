...
func (m *MockUserDAO) FindByIdV1(ctx context.Context, uid any) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDAOMockRecorder) FindByIdV1(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByIdV1", reflect.TypeOf((*MockUserDAO)(nil).FindByIdV1), ctx, uid)
}
...
func (m *MockUserDAO) FindByWechat(ctx context.Context, id string) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDAOMockRecorder) FindByWechat(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByWechat", reflect.TypeOf((*MockUserDAO)(nil).FindByWechat), ctx, id)
}
...
func (m *MockUserDAO) UpdateByUid(ctx context.Context, entity dao.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateByUid", ctx, entity)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateByUid indicates an expected call of UpdateByUid.
func (mr *MockUserDAOMockRecorder) UpdateByUid(ctx, entity any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateByUid", reflect.TypeOf((*MockUserDAO)(nil).UpdateByUid), ctx, entity)
}
